...
private:
	...
	Mat lab_alignment_new_convexhull(Mat);
	Mat lab_alignment_binarySearch(Mat,Mat&);
	void read_lab_csv();
	...
	//void TSP_boost_for_histogram_coarse_to_fine4(Mat, Mat&);
